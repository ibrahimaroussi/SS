...
${OBJECTDIR}/Communication/fonctionsComm.o: Communication/fonctionsComm.c
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Communication/fonctionsComm.o Communication/fonctionsComm.c

${OBJECTDIR}/Communication/serveur.o: Communication/serveur.c
	${MKDIR} -p ${OBJECTDIR}/Communication
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Communication/serveur.o Communication/serveur.c

${OBJECTDIR}/Major/fonctions.o: Major/fonctions.c
	${MKDIR} -p ${OBJECTDIR}/Major
	${RM} "$@.d"
	$(COMPILE.c) -g -std=c99 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Major/fonctions.o Major/fonctions.c
